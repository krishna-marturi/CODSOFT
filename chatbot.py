...
# --- 1. CORE DICTIONARY (Standard Keyword Pattern Matching) ---
rules = {
    ...
    "python": (["python", "coding", "programming"], "🐍 **Python:** A friendly, readable language used as the core backbone for AI/ML development."),
    "ai": (["artificial intelligence", "ai"], "🧠 **AI:** Technology that trains computers to think, analyze, and make decisions like humans."),
    "ml": (["machine learning", "ml"], "📊 **ML:** A branch of AI where models learn pattern sets automatically from old input data."),
    "internship": (["internship", "task", "codsoft"], "💼 **Internship:** Build practical project tracks like this Task 1 to scale your software portfolio, {name}!"),
    "help": (["help", "menu", "options"], "💡 Ask me about: *Greetings, Name, College, Python, AI, ML, Internship, or Time*. Type *'bye'* to exit.")
}

# --- 2. FUNCTION LAYOUT STRUCTURE ---
def get_bot_response(user_text, name):
    """Processes dictionary rules pattern matching and returns custom response strings."""
